...
int main(int argc, char **argv){
	...
	int i,tmp;
	int cores,children,status; //children is the number of child processes it the parent process created, status is the status of a watied child process
	...
	fgets(scheduling,MAXLENGTH,fpin);
	printf("%s\n",scheduling);
	/*
